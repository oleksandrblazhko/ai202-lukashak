...
const client = {"id":"123","username":"DanBear","password":"555qqq","secret_key":"5e0dd59c8686b2ed36a50a9f428cf39f305a1fb5c0d2f842a5b2716bae9e0004"};

class DataBase {
    async init() {
        const mongoClient = await new MongoClient('mongodb://admin:111111@localhost:27017/project', {
